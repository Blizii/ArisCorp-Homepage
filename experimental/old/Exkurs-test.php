    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="excurs" class='large-margin'>
                ...
                <div class="row heading tiny-margin"></div>
                <div class="row medium-margin tab-manifesto">

                    <div class="tab">
                        <button class="tablinks" onclick="location.href='?tab=exkurs'"><img src="https://www.ariscorp.de/assets/img/excurs/util/ARISBannerVerseExkurs.webp" alt="" width="100%" height="auto"></button> <br> <br> <br> <br>
                        ...
                        <button class="tablinks" onclick="location.href='?tab=map'"><h1 style="float: left"><span class="coloredwhite" style="font-size: unset;">A</span>RK-STARMAP</h1></button>
                    </div>
                </div>
