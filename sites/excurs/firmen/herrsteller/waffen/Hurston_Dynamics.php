...
<html lang="en">
<!-- /// HEAD INCLUDE /// -->
  <title>ARISCORP - Verse-Excurs - Firmen - Herrsteller - Waffen : Hurston Dynamics</title>
        ...
        <div id="EXCURS" class='large-margin'>
            ...
            <div class="row heading tiny-margin">
                <div class="col-md-auto">
                    <h1 class="animation-element slide-down">WAFFENHERRSTELLER: <span class="coloredaris">HURSTON DYNAMICS</span></h1>
                </div>
                <div class="col">
