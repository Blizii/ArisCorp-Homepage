<div class="img-gameplays-line">
                    ...
                    <div id="uee-reg" class="" style="padding: 6px 12px; border: 1px solid transparent; border-top: none; font-family: 'Nasa';">
                        ...
                        <span>Laylani Addison, geboren 2889, ist unsere aktuelle Imperatrix im United Empire of Earth (UEE). Zuvor war sie Dekanin für angewandte Wissenschaften (2931-2947) und davor neun Jahre Professorin für integrierte Wissenschaft und Xenotechnologie an der Mentor University.</span>

                        <br>
                        <br>

                        <span>Ihr Wahlprogramm umfasst Pläne für eine Innovationsinitiative, die die derzeitigen Beschränkungen für KI-Forschung lockern und die Ausgaben für Bildung und wissenschaftliche Forschung erhöhen wird. Sie versucht, die Finanzierung von öffentlich subventionierten Universitäten zu steigern, die Beziehungen zwischen menschlichen und außerirdischen Zivilisationen zu stärken, mehr Mittel für Synthworld bereitzustellen und ein Regierungsprogramm zu schaffen, um das verlorene menschliche Kolonieschiff "Artemis" zu lokalisieren. Sie ist keiner politischen Partei angeschlossen.</span>
                        ...
                        <h2 style="font-family: 'Nasa'">High Secretary</h2>
                        <span>Er wacht über alles, was in der UEE für das Zusammenleben von grosser Bedeutung ist - Kommunikation, Transport, Abwasser, Strom, Landwirtschaft, und anderes mehr. Alle Fragen im Zusammenhang mit der Infrastruktur der UEE werden vom Senat diskutiert, dann an den High Secretary weitergeleitet, bevor auch der Imperator darüber befindet.</span>

                        <br>
                        <br>

                        <h2 style="font-family: 'Nasa'">High Advocate</h2>
                        ...
                        <h2 style="font-family: 'Nasa'">Senatoren</h2>
                        <span>Gewählt von den Bürgern ihrer jeweiligen Planeten, arbeiten Senatoren hauptsächlich im UEE-senat. Senatoren schaffen keine direktelokale Gesetzgebung oder ernennen lokale Beamte, aber ihre Unterstützung und ihr Einfluss sind unbestreitbar mächtig.</span>

                        <br>
                        <br>

                        <h2 style="font-family: 'Nasa'">Parteien</h2>
                        <span>Aufgrund der enormen Größe des UEE gibt es hunderte verschiedene politischeParteien, aber es gibt drei, die die politische Landschaft dominieren. </span>

                        <br>
                        <br>

                        <span style="font-size: 120%; font-weight: bold;">Universalisten </span><span> - Institutionsfokussierte ideologie. Regierung und Systeme leiten die Menschen. Von manchen als vermögensorientiere Ideologie angesehen.</span>

                        <br>
                        <br>

                        <span style="font-size: 120%; font-weight: bold;">Zentralisten </span><span>- Liberale polotische Ideologie. Es geht darum, den Status quo zu pflegen. Die Partei setzt sich dafür ein, dass die Erde der wichtigste Ort des UEE ist und bleibt.</span>

                        <br>
                        <br>

                        <span style="font-size: 120%; font-weight: bold;">Transitionalisten </span><span> - Relativ junge "Volkspartei". Der größeste Teilihrer Rhetorik ist auf "Zukunft" Und "Fortschritt" gerichtet. Sie Unterstützen Terra als das künftige Zentrun des UEE.</span>
