<div class="img-gameplays-line">
                    ...
                    <div id="uee-leben" class="" style="padding: 6px 12px; border: 1px solid transparent; border-top: none; font-family: 'Nasa';">
                        ...
                        <h2 style="font-family: 'Nasa'">Schulische-Äquivalenz</h2>
                        <span>Die Grund-Ausbildung erfolgt digital und über Computersysteme. Eine Vielzahl von Unternehmen hat durch imperiale Subventionen Lernprogramme geschaffen, die in der Lage sind, Kinder zur Erreichung der Gleichwertigkeit, der so genannten "äguivalenz", vergleichbar mit dem Niveau einer High School im 21. Jahrhundert zu erzielen. Diese Programme werden in der Regel auf Grenzplaneten und in ländlichen Gebieten eingesetzt, die keinen direkten Zugang zu einer Schule haben.  Es handelt sich im Grunde genommen um ein Multiple -Choice-Quiz, so dass es sehr wenig Möglichkeiten gibt, interpretatives Denken zu entwickeln. Es geht nur darum, Fakten zu vermitteln.</span>

                        <br>
                        <br>

                        <span>Der nächste Schritt ist eine öffentliche Schule. Einige öffentliche Schulen, zum Beispiel in den Megacitys, unterrichten bis zu fünfhundert Schüler in einem Klassenzimmer gleichzeitig. In dieser Umgebung wird der grösste Teil des Wissens über Monitore vermittelt, aber es gibt auch immer noch einen Lehrer, der sich um die gelegentlichen Fragen kümmert und Essays bewertet. Der dritte Schritt ist eine private Akademie, die zwar tür ist, aber die besten Bildungsdienstleistungen von qualifizierten Lehrern anbietet. Diese Akademien bieten Stipendien für aussergewöhnliche Studenten, aber viele argumentieren, dass dies nur dazu dient, Zugang zu erhöhter Budgethilfe zu erhalten.</span>

                        <br>
                        <br>
                        <br>

                        <h2 style="font-family: 'Nasa'">Nachäquivalenz</h2>
                        <span>Nach Erreichen der äquivalen zhat ein Student mehrere Möglichkeiten: Eintritt ins Berufsleben, Eintritt ins Militär oder eine Hochschulbildung. Während die erste Option in der Regel keinen Gleichwertigkeitsnachweis erfordert, tun es das Militär und die Universitäten. Das Militär bietet engagierten Bewerbern äquivalenz kurse an, kann aber auch auf die äquivalenz forderung verzichten, wenn der Rekrut über "wünschenswerte Fähigkeiten" verfügt. Da die Hochschulbildung allein nicht für die Staatsbürgerschaft qualifiziert, tritt eine grosse Zahl von Hochschulabsolventen dem Militär bei.</span>
                        ...
                        <h2 style="font-family: 'Nasa'; float: left;">Transportwesen</h2>

                        <br>

                        <h3 style="font-family: 'Nasa'; float: left;">Am Boden</h3>
                        <span>Auch im 30. Jahrhundert existiert noch bodengebundener Verkehr. Vor allem auf den Grenzplaneten gibt es noch eine grosse Anzahl von Transporten. In den bevölkerungsreicheren Systemen existieren ebenfalls noch Strassen und Fahrzeuge, sie sind aber nicht mehr die dominierende Form des Planetarischen Transports. Diese Aufgabe haben HoverCars übernommen.</span>

                        <br>
                        <br>

                        <h3 style="font-family: 'Nasa'; float: left;">Im Weltall</h3>
                        <span>Für die allgemein Bevölkerung sind Raumschiffe und Interplanetare Reisen eine Alltag gewordene Realität,  aber das bedeutet nicht, dass jeder auch ein Raumschiff besitzt. Sie sind nicht so verbreitet wie Autos zu beginn des 21. Jahrunderts. Gleichzeitig ist die Raumfahrt nicht etwas für die Reichen. Eine Vielzahl von Menschen mit unterschiedlichem sozialem und finanziellem Hitergrund sind zu den Sternen gegangen - in Schiffen der verschiedensten Preis- und Ausstatungskategorien.</span>

                        <br>
                        <br>

                        <h3 style="font-family: 'Nasa'; float: left;">In Atmosphären</h3>
                        <span>Wenn unzählige fliegende Fahrzeuge die Städte durchqüren und zudem pausenlos Schiffe aus dem Orbit ankommen und abfliegen, sollte man meinen, dass es häufig Kollisionen gibt. Um diese Gefahr zu bannen, gibt es Flugkorridore, in denen Flüge nur in eine Richtung erlaubt sind. Auch für Raumschiffe existieren spezielle An- und Abflugrouten. Diese führen zu denLandeplätzen.</span>

                        <br>
                        <br>
                        <br>

                        <h2 style="font-family: 'Nasa'; float: left;">Kommerzieller Reiseverkehr</h2>
                        ...
                        <h2 style="font-family: 'Nasa'; float: left;">Technologie Im Alltag</h2>
                        <span>überall im Verse finden sich Konsolen - von den Schirmen auf der Kommandozentrale eines Bengal- Trägers bis zu den kleinen Monitoren im Cockpit des eigenen Schiffes. Alle haben Standard6 Touchscreen- Schnittstellen mit virtüllen Tastaturen.</span>

                        <br>

                        <span>Wandschirme sin genau das, wonach es klingt: eine dünne, Flexible Folie, die sich an jede Wandgrösse anpassen lässt und als Kombination aus Fernesehen und Computer-displays fungiert. Die meisten Wand schirme sind gleichzeitig Touchscreens und High-End- Modelle erkennen Handbefehle. </span>

                        <br>

                        <span>Auch Holografische Projekttionen sind überall im verse allgegenwertig. Egal ob Werbetafeln oder Informations-displays. </span>
                        ...
                        <h2 style="font-family: 'Nasa'">Feiertage im 30. Jahrhundert</h2>
